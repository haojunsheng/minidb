...
// manges the catalog information, and stores the information on disk using boost serialization library.
// The information includes databases, tables, indexes, and attributes.
