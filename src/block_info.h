...
private:
  FileInfo *file_;
  int block_num_; // the blocknumber of the block, which indicate
  char *data_;
  bool dirty_; // 0 ->flase, 1 -> indicate dirty, write back
  long age_;
  BlockInfo *next_; // the pointerpoint to next block
